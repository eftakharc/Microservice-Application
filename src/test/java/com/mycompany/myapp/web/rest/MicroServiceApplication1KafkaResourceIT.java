...
class MicroServiceApplication1KafkaResourceIT {
    ...
    void setup() {
        ...
        MicroServiceApplication1KafkaResource kafkaResource = new MicroServiceApplication1KafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/micro-service-application-1-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/micro-service-application-1-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
