...
@RestController
@RequestMapping("/api/micro-service-application-1-kafka")
public class MicroServiceApplication1KafkaResource {
    private final Logger log = LoggerFactory.getLogger(MicroServiceApplication1KafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public MicroServiceApplication1KafkaResource(KafkaProperties kafkaProperties) {
